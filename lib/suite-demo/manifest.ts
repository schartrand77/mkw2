...
export const SUITE_DEMO_SCREENSHOTS: SuiteDemoScreenshot[] = [
  ...
  },
  {
    ...
    filename: 'makerworks-09-print-job-detail.png',
    path: '/admin/users/mw-demo-customer-user/orders/mw-demo-order-1001',
    description: 'Admin print job detail page showing the demo order, production controls, and PrintLab submission status.',
    optional: true,
  ...
  },
  {
    ...
    filename: 'makerworks-10-admin-inventory.png',
  ...
  },
  {
    ...
    path: '/',
    description: 'Representative safe fake printer fleet screenshot mirrored into the PrintLab repo.',
    waitForText: 'PrintLab',
  },
  {
    app: 'Suite Flow',
